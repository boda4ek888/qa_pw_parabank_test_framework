...
type UserData = { firstName: string; lastName: string; city: string; address: string; zipCode: string; state: string; phone: string; ssn: string; username: string; password: string; passwordConfirmation: string };
